  ...
  return (
    <div className="user-profile-details">
      ...
      <div className="profile-info-grid">
        <p><b>{t('emailLabel' as any)}:</b> {profile.email}</p>
        <p><b>{t('cityLabel' as any)}:</b> {profile.city}</p>
        <p><b>{t('weightLabel' as any)}:</b> {profile.weight}</p>
        <p><b>{t('genderLabel' as any)}:</b> {t(profile.gender.toLowerCase() as any)}</p>
      </div>
